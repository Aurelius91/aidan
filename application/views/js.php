...
<script type="text/javascript">
	...
	function navbarClick() {
		$('#btn-search-desktop').click(function() {
			var inputSearch = $('#input-desktop-search').val();

			var inputSearchEncode = encodeURIComponent(inputSearch);
			search(inputSearchEncode);
		});

		$('#btn-search-mobile').click(function() {
			var inputSearch = $('#search-mobile').val();
	...
	function navbarKeypress() {
		...
		$('#input-desktop-search').keypress(function(e) {
			if (e.which == 13) {
				var inputSearch = $('#input-desktop-search').val();
	...
	function search(inputSearch) {
		window.location.href = "<?= base_url(); ?>search/query/"+ inputSearch +"/"
	}
</script>
