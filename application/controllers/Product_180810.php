...
class Product extends CI_Controller
{
    ...
    public function filter($page = 1, $sort = 'newest', $collection_id = 0, $category = 0, $look = 0, $alterego = 0, $color_id = 0)
    {
        $useragent = $_SERVER['HTTP_USER_AGENT'];
        $arr_data['mobile'] = false;
        ...
        $arr_data['arr_currency'] = $this->cms_function->get_currency();
        $arr_data['last_cart'] = $this->cms_function->generate_cart();
        $arr_data['arr_product'] = $this->_generate_product($page, $sort, $collection_id, $arr_choosen_category, $arr_choosen_look, $arr_choosen_alterego, $color_id);
        $arr_data['count_page'] = $this->_count_product($sort, $collection_id, $arr_choosen_category, $arr_choosen_look, $arr_choosen_alterego, $color_id);
        $arr_data['page'] = $page;
        $arr_data['sort'] = $sort;
        $arr_data['collection_id'] = $collection_id;
    ...
    private function _count_product($sort, $collection_id, $arr_choosen_category_id, $arr_choosen_look_id, $arr_choosen_alterego_id, $color_id)
    {
    ...
    private function _generate_product($page, $sort, $collection_id, $arr_choosen_category_id, $arr_choosen_look_id, $arr_choosen_alterego_id, $color_id)
    {
        // get currency
        $currency = $this->core_model->get('currency', $this->_currency);
