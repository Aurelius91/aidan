...
<body class="dashboard">
	...
	<div class="ui small inverted modal modal-log">
		<div class="image content" style="background-color: #fff; color: 2c2c2c;">
			<div class="description" style="text-align: center;">
				...
				<p><a href="mailto:fahriza@labelideas.co" style="color: #2c2c2c;">Fahriza (Account Manager)</a></p>
				<p><a href="mailto:garniasih@labelideas.co" style="color: #2c2c2c;">Garniasih (Brand Strategist)</a></p>
				<p><a href="mailto:witnes@labelideas.co" style="color: #2c2c2c;">Witnes Alif (Art Director)</a></p>
				<p><a href="mailto:gilang@labelideas.co" style="color: #2c2c2c;">Gilang Ilham (Digital Designer)</a></p>
	...
	<div class="ui vertical menu">
		<div class="item" style="padding: 12px 15px;">
			<a href="<?= base_url(); ?>">
				<img style="width: 19.5%;" src="<?= base_url(); ?>images/admin/logo.png">
			</a>
		</div>
		<div class="item">
			Quick Access
		...
		<? if (isset($acl['website']) && $acl['website']->list > 0): ?>
			<div class="ui dropdown item html-dropdown-left-menu">
				...
				<div class="menu">
					...
					<a href="<?= base_url(); ?>section/view/2/1/" class="<? if ($type == 'Section-2'): ?>active<? endif; ?> item"><i class="clone icon"></i> About Us Page</a>
					<a href="<?= base_url(); ?>section/view/6/1/" class="<? if ($type == 'Section-6'): ?>active<? endif; ?> item"><i class="clone icon"></i> Muse Page</a>
					<a href="<?= base_url(); ?>section/view/7/1/" class="<? if ($type == 'Section-7'): ?>active<? endif; ?> item"><i class="clone icon"></i> Media Page</a>
					<a href="<?= base_url(); ?>section/view/8/1/" class="<? if ($type == 'Section-8'): ?>active<? endif; ?> item"><i class="clone icon"></i> Events Page</a>
					<a href="<?= base_url(); ?>section/view/9/1/" class="<? if ($type == 'Section-9'): ?>active<? endif; ?> item"><i class="clone icon"></i> Terms & Conditions Page</a>
					<a href="<?= base_url(); ?>section/view/10/1/" class="<? if ($type == 'Section-10'): ?>active<? endif; ?> item"><i class="clone icon"></i> Shipping & Exchange Page</a>
					<a href="<?= base_url(); ?>section/view/11/1/" class="<? if ($type == 'Section-11'): ?>active<? endif; ?> item"><i class="clone icon"></i> Privacy Policy Page</a>
					<a href="<?= base_url(); ?>section/view/12/1/" class="<? if ($type == 'Section-12'): ?>active<? endif; ?> item"><i class="clone icon"></i> Join Our Team Page</a>
					<a href="<?= base_url(); ?>section/view/13/1/" class="<? if ($type == 'Section-13'): ?>active<? endif; ?> item"><i class="clone icon"></i> Contact Us Page</a>

					<a href="<?= base_url(); ?>slideshow/view/1/" class="<? if ($type == 'Slideshow'): ?>active<? endif; ?> item"><i class="image icon"></i> Home Slideshow</a>
					<a href="<?= base_url(); ?>stockist/view/1/" class="<? if ($type == 'Stockist'): ?>active<? endif; ?> item"><i class="map pin icon"></i> Stockist</a>
				</div>
			</div>
		<? endif; ?>

		<? if ((isset($acl['customer']) && $acl['customer']->list > 0) || (isset($acl['vendor']) && $acl['vendor']->list > 0) || (isset($acl['location']) && $acl['location']->list > 0) || (isset($acl['category']) && $acl['category']->list > 0) || (isset($acl['brand']) && $acl['brand']->list > 0) || (isset($acl['product']) && $acl['product']->list > 0) || (isset($acl['currency']) && $acl['currency']->list > 0) || (isset($acl['voucher']) && $acl['voucher']->list > 0) || (isset($acl['collection']) && $acl['collection']->list > 0) || (isset($acl['alterego']) && $acl['alterego']->list > 0) || (isset($acl['color']) && $acl['color']->list > 0) || (isset($acl['bank']) && $acl['bank']->list > 0)): ?>
			<div class="ui dropdown item html-dropdown-left-menu">
				Data <i class="dropdown icon"></i>
				<div class="menu">
					<? if ((isset($acl['customer']) && $acl['customer']->list > 0) || (isset($acl['vendor']) && $acl['vendor']->list > 0) || (isset($acl['location']) && $acl['location']->list > 0) || (isset($acl['currency']) && $acl['currency']->list > 0) || (isset($acl['voucher']) && $acl['voucher']->list > 0) || (isset($acl['bank']) && $acl['bank']->list > 0)): ?>
						<div class="ui dropdown item html-dropdown-left-menu">
							...
							<div class="menu">
								...
								<? if (isset($acl['currency']) && $acl['currency']->list > 0): ?>
									<a href="<?= base_url(); ?>currency/view/1/" class="<? if ($type == 'Currency'): ?>active<? endif; ?> item"><i class="money bill alternate icon"></i> Currency</a>
								<? endif; ?>

								<? if (isset($acl['voucher']) && $acl['voucher']->list > 0): ?>
									<a href="<?= base_url(); ?>voucher/view/1/" class="<? if ($type == 'Voucher'): ?>active<? endif; ?> item"><i class="money bill alternate icon"></i> Voucher</a>
								<? endif; ?>

								<? if (isset($acl['bank']) && $acl['bank']->list > 0): ?>
									<a href="<?= base_url(); ?>bank/view/1/" class="<? if ($type == 'Bank'): ?>active<? endif; ?> item"><i class="money bill alternate icon"></i> Bank</a>
								<? endif; ?>
							</div>
						</div>
					<? endif; ?>

					<? if ((isset($acl['category']) && $acl['category']->list > 0) || (isset($acl['brand']) && $acl['brand']->list > 0) || (isset($acl['product']) && $acl['product']->list > 0) || (isset($acl['collection']) && $acl['collection']->list > 0) || (isset($acl['alterego']) && $acl['alterego']->list > 0) || (isset($acl['color']) && $acl['color']->list > 0)): ?>
						<div class="ui dropdown item html-dropdown-left-menu">
							...
							<div class="menu">
								...
								<? if (isset($acl['alterego']) && $acl['alterego']->list > 0): ?>
									<a href="<?= base_url(); ?>alterego/view/1/" class="<? if ($type == 'Alter Ego'): ?>active<? endif; ?> item"><i class="tags icon"></i> Alter Ego</a>
								<? endif; ?>

								<? if (isset($acl['color']) && $acl['color']->list > 0): ?>
									<a href="<?= base_url(); ?>color/view/1/" class="<? if ($type == 'Color'): ?>active<? endif; ?> item"><i class="tags icon"></i> Color</a>
								<? endif; ?>

								<? if (isset($acl['collection']) && $acl['collection']->list > 0): ?>
									<a href="<?= base_url(); ?>collection/view/1/" class="<? if ($type == 'Collection'): ?>active<? endif; ?> item"><i class="tags icon"></i> Collection</a>
								<? endif; ?>
		...
		<? if ($setting->system_mac == 'webshop_2_aidan'): ?>
			<? if (isset($acl['receive']) && $acl['receive']->list > 0): ?>
				<a href="<?= base_url(); ?>receive/view/1/" class="<? if ($type == 'Receive'): ?>active<? endif; ?> item"><i class="truck icon"></i> Receive</a>
			<? endif; ?>
		<? else: ?>
		...
		<? if ((isset($acl['muse']) && $acl['muse']->list > 0) || (isset($acl['media']) && $acl['media']->list > 0) || (isset($acl['events']) && $acl['events']->list > 0)): ?>
			<div class="ui dropdown item html-dropdown-left-menu">
				Journal <i class="dropdown icon"></i>
				<div class="menu">
					<? if (isset($acl['muse']) && $acl['muse']->list > 0): ?>
						<a href="<?= base_url(); ?>muse/view/1/" class="<? if ($type == 'Muse'): ?>active<? endif; ?> item"><i class="newspaper outline icon"></i> Muse</a>
					<? endif; ?>

					<? if (isset($acl['media']) && $acl['media']->list > 0): ?>
						<a href="<?= base_url(); ?>media/view/1/" class="<? if ($type == 'Media'): ?>active<? endif; ?> item"><i class="newspaper outline icon"></i> Media</a>
					<? endif; ?>

					<? if (isset($acl['events']) && $acl['events']->list > 0): ?>
						<a href="<?= base_url(); ?>events/view/1/" class="<? if ($type == 'Events'): ?>active<? endif; ?> item"><i class="newspaper outline icon"></i> Events</a>
					<? endif; ?>
				</div>
			</div>
		<? endif; ?>
		...
		<? if (isset($acl['career']) && $acl['career']->list > 0): ?>
			<a href="<?= base_url(); ?>career/view/1/" class="<? if ($type == 'Career'): ?>active<? endif; ?> item"><i class="clipboard list icon"></i> Career</a>
		<? endif; ?>
