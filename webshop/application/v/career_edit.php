	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#career-date-end').val("<?= $career->date_end_display; ?>");
			...
			var image = '<img class="preview" style="width: 100%;" src="<?= base_url(); ?>images/website/<?= $career->image_name; ?>">';
			$('#preview').append(image);
		}
					...
					<div class="ui form">
						...
						<div class="two fields">
							<div class="field">
								...
								<textarea id="career-description" placeholder="Description.."><?= $career->description; ?></textarea>
							</div>
							<div class="field">
								<label>Qualification</label>
								<textarea id="career-qualification" placeholder="Qualification.."><?= $career->qualification; ?></textarea>
							</div>
						</div>
