				...
				<div class="form-content">
					<div class="ui form">
						...
						<div class="field">
							...
							<textarea id="muse-description-3" placeholder="Content 3.."></textarea>
						</div>
						...
						<div class="three fields">
							...
							<div class="field">
								...
								<div>Recommended Size: 1920px x 880px</div>
								<div style="padding-bottom: 5px;">Max File Size: 500kb</div>
								<input id="main-image6" class="form-input data-important" placeholder="Upload Image.." type="File">
							</div>
						</div>
