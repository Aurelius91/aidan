	...
	<script type="text/javascript">
		...
		function reset() {
			...
			var image2 = '<img class="preview2" style="width: 100%;" src="<?= base_url(); ?>images/website/<?= $slideshow->image_mobile_name; ?>">';
					...
					<div class="ui form">
						...
						<div class="two fields">
							<div class="field">
								...
								<textarea id="slideshow-description" placeholder="Description - <?= $setting->setting__system_language; ?>.."><?= $slideshow->description; ?></textarea>
							</div>
							<div class="field">
								<label>Description - <?= $setting->setting__system_language2; ?></label>
								<textarea id="slideshow-description-lang" placeholder="Description - <?= $setting->setting__system_language2; ?>.."><?= $slideshow->description_lang; ?></textarea>
							</div>
						</div>
