	...
	<script type="text/javascript">
		...
		function reset() {
			$('#muse-name').val("");
			$('#muse-subtitle').val("");
			$('#muse-short-description').val("");
			$('#muse-date').val("");

			$('#muse-title-1').val("");
			$('#muse-title-2').val("");
			$('#muse-description-1').val("");
			$('#muse-description-2').val("");

			$('#muse-custom-text-1').val("");
			$('#muse-custom-text-2').val("");

			$('#muse-product').val("");
			$('#muse-product-container').dropdown('set selected', "");

			$('#main-image-cover').val("");
			$('#preview-cover').data('image_id', 0);

			$('#muse-metatag-title').val("");
			$('#muse-metatag-author').val("");
			$('#muse-metatag-keywords').val("");
			$('#muse-metatag-description').val("");
		...
		function submit() {
			...
			var museTitle2 = $('#muse-title-2').val();
			...
			var museCustomText1 = $('#muse-custom-text-1').val();
			var museCustomText2 = $('#muse-custom-text-2').val();
			...
			$.ajax({
				data :{
					...
					custom_text_1: museCustomText1,
					custom_text_2: museCustomText2,
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Add New Muse - Template 1</div>
				</div>
				<div class="form-content">
					<div class="ui form">
						...
						<div class="two fields">
							<div class="field">
								<label>Title 1</label>
								<input id="muse-title-1" class="form-input" placeholder="Title 1.." type="text">
							</div>
							<div class="field">
								<label>Title 2</label>
								<input id="muse-title-2" class="form-input" placeholder="Title 2.." type="text">
							</div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<textarea id="muse-description-1" placeholder="Content 1.."></textarea>
							</div>
							<div class="field">
								<label>Content 2</label>
								<textarea id="muse-description-2" placeholder="Content 2.."></textarea>
							</div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								...
								<input id="muse-custom-text-1" class="form-input" placeholder="Custom Text 1.." type="text">
							</div>
							<div class="field">
								<label>Custom Text 2</label>
								<input id="muse-custom-text-2" class="form-input" placeholder="Custom Text 2.." type="text">
							</div>
						</div>
						...
						<div class="three fields">
							<div class="field">
								...
								<input id="main-image-cover" class="form-input data-important" placeholder="Upload Image.." type="File">
							</div>
						...
						<div class="three fields">
							<div class="field">
								...
								<div>Recommended Size: 1920px x 880px</div>
								<div style="padding-bottom: 5px;">Max File Size: 500kb</div>
								<input id="main-image3" class="form-input data-important" placeholder="Upload Image.." type="File">
							</div>
							...
							<div class="field">
								...
								<div>Recommended Size: 1920px x 880px</div>
								<div style="padding-bottom: 5px;">Max File Size: 500kb</div>
								<input id="main-image4" class="form-input data-important" placeholder="Upload Image.." type="File">
							</div>
							...
							<div class="field">
								...
								<div>Recommended Size: 1920px x 880px</div>
								<div style="padding-bottom: 5px;">Max File Size: 500kb</div>
								<input id="main-image5" class="form-input data-important" placeholder="Upload Image.." type="File">
							</div>
						</div>
