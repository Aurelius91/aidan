	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#product-category-looks-container').dropdown('set selected', "");

			$('#product-collection').val("");
			$('#product-collection-container').dropdown('set selected', "");

			$('#product-alterego').val("");
			$('#product-alterego-container').dropdown('set selected', "");

			$('#product-color').val("");
			$('#product-color-container').dropdown('set selected', "");

			$('#product-metatag-title').val("");
			$('#product-metatag-author').val("");
			$('#product-metatag-keywords').val("");
			$('#product-metatag-description').val("");
						...
						<div class="field">
							<div class="two fields">
								<div class="field">
									...
									<textarea id="product-description" class="form-input" placeholder="Description - <?= $setting->setting__system_language; ?>.."></textarea>
								</div>
								<div class="field">
									<label>Description - <?= $setting->setting__system_language2; ?></label>
									<textarea id="product-description-lang" class="form-input" placeholder="Description - <?= $setting->setting__system_language2; ?>.."></textarea>
								</div>
							</div>
						</div>
