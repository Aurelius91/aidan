	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#setting-company-email-2').val("<?= $setting->company_email2; ?>");
			$('#setting-company-phone').val("<?= $setting->company_phone; ?>");
			$('#setting-company-phone-2').val("<?= $setting->company_phone2; ?>");
			$('#setting-company-opening-time').val("<?= $setting->company_opening_time; ?>");
			...
			$('#setting-skype-url').val("<?= $setting->setting__social_media_skype_link; ?>");
		...
		function submit() {
			...
			var companyEmail2 = $('#setting-company-email-2').val();
			var companyPhone = $('#setting-company-phone').val();
			var companyPhone2 = $('#setting-company-phone-2').val();
			var companyOpeningTime = $('#setting-company-opening-time').val();

			var facebookUrl = $('#setting-facebook-url').val();
			var twitterUrl = $('#setting-twitter-url').val();
			var skypeUrl = $('#setting-skype-url').val();
						...
						<div class="field">
							...
							<div class="two fields">
								...
								<div class="field">
									...
									<input id="setting-company-email-2" placeholder="Company Email 2" type="text">
								</div>
							</div>
							<div class="field">
								<div class="two fields">
									...
									<div class="field">
										...
										<input id="setting-company-phone-2" placeholder="Company Phone 2.." type="text">
									</div>
								</div>
							</div>
							<div class="field">
								<label>Company Opening Time</label>
								<input id="setting-company-opening-time" placeholder="Company Opening Time.." type="text">
							</div>
						</div>
						...
						<div class="field">
							...
							<div class="two fields">
								<div class="field">
									...
									<input id="setting-skype-url" placeholder="Company Phone.." type="text">
								</div>
								<div class="field">
