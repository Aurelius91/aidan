	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#muse-title-2').val("<?= $muse->title_2; ?>");

			$('#muse-custom-text-1').val("<?= $muse->custom_text_1; ?>");
			$('#muse-custom-text-2').val("<?= $muse->custom_text_2; ?>");
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				<div class="ui attached message setting-header">
					<div class="header">Edit Muse - Template 1</div>
				</div>
