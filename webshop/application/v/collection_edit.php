	...
	<script type="text/javascript">
		...
		function back() {
			window.location.href = '<?= base_url(); ?>collection/view/1/';
		}
		...
		function reset() {
			...
			var image = '<img class="preview" style="width: 100%;" src="<?= base_url(); ?>images/website/<?= $collection->image_name; ?>">';
			$('#preview').append(image);
		}
		...
		function submit() {
			...
			$.ajax({
				...
				type : 'POST',
				url : '<?= base_url() ?>collection/ajax_edit/<?= $collection->id; ?>/',
				xhr: function() {
					var percentage = 0;
					var xhr = new window.XMLHttpRequest();
		...
		<div class="ui stackable one column centered grid">
			<div class="column">
				...
				<div class="form-content">
					<div class="ui form">
						<h4 class="ui dividing header">Collection - Details</h4>
						<div class="two fields">
							<div class="field">
								<label>Name <span class="color-red">*</span></label>
								<input id="collection-name" class="form-input data-important" placeholder="Name.." type="text">
							</div>
							<div class="field">
								<label>Description</label>
								<input id="collection-description" class="form-input" placeholder="Description.." type="text">
							</div>
						</div>
