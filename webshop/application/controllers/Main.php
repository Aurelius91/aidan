...
class Main extends CI_Controller
{
	...
	public function index()
	{
		...
		{
			$weekly_sale->date_formatted = date('Y-m-d 00:00:00', $weekly_sale->date);
			$weekly_sale->date_formatted = strtotime($weekly_sale->date_formatted);
			$arr_analytic[$weekly_sale->date_formatted]->count_date = $weekly_sale->count_date;
		}
